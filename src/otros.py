...
# INICIO - Hash.
def calcular_hash_otro(ruta_otro):
    """
    Calcula un hash SHA-256 del contenido del archivo.
    """
    try:
...
# INICIO - Ejecución.
def obtener_archivos_otros(carpeta_origen):
    """
...
def buscar_duplicados_otros(carpeta_origen):
    """
...
def mover_duplicados_otros(duplicados, carpeta_destino):
    """
